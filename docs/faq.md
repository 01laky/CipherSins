...
**4 of 8** MVP rules at **0.5.0**: CS-JWT-01, CS-CMP-01, CS-RNG-01, CS-HASH-01. See [rules index](./rules/README.md).
...
Run `pnpm test` or `npm test` for the full suite (298 tests at v0.5.0).
