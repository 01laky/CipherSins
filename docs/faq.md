...
**3 of 8** MVP rules at **0.4.2**: CS-JWT-01, CS-CMP-01, CS-RNG-01. See [rules index](./rules/README.md).
...
Run `pnpm test` or `npm test` for the full suite (200 tests at v0.4.2).
